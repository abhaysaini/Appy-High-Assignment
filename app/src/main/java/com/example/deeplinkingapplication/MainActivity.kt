...
//            tab.url
            ...
            try{
                ...
                domainUriPrefix = "https://mydeeplinkingproject.page.link"
                androidParameters() {}
                ...
                if (pendingDynamicLinkData != null) {
                    ...
                    if(!isPackageInstalled("jp.hazuki.yuzubrowser" , pm)){
                        val intent = Intent(Intent.ACTION_VIEW).apply {
                            ...
                            data = Uri.parse("https://play.google.com/store/apps/details?id=jp.hazuki.yuzubrowser")
                        ...
                        val url = deepLink.toString()?.substring(19)
